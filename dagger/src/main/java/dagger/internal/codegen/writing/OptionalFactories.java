...
final class OptionalFactories {
    ...
    private final ComponentImplementation.ShardImplementation rootComponentShard;
    ...
    private static CodeBlock transformFutureToOptional(
            OptionalType.OptionalKind optionalKind, TypeName inputType, CodeBlock inputFuture) {
        return CodeBlock.of(
