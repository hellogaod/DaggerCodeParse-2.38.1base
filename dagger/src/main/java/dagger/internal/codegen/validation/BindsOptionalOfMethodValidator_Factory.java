...
public final class BindsOptionalOfMethodValidator_Factory implements Factory<BindsOptionalOfMethodValidator> {
    ...
    public BindsOptionalOfMethodValidator_Factory(Provider<DaggerElements> elementsProvider,
    ...
    @Override
    public BindsOptionalOfMethodValidator get() {
    ...
    public static BindsOptionalOfMethodValidator_Factory create(
            ...
            Provider<DependencyRequestValidator> dependencyRequestValidatorProvider,
            Provider<InjectionAnnotations> injectionAnnotationsProvider) {
        return new BindsOptionalOfMethodValidator_Factory(elementsProvider, typesProvider, kotlinMetadataUtilProvider, dependencyRequestValidatorProvider, injectionAnnotationsProvider);
    }

    public static BindsOptionalOfMethodValidator newInstance(DaggerElements elements,
                                                             DaggerTypes types, KotlinMetadataUtil kotlinMetadataUtil, Object dependencyRequestValidator,
                                                             InjectionAnnotations injectionAnnotations) {
        return new BindsOptionalOfMethodValidator(elements, types, kotlinMetadataUtil, (DependencyRequestValidator) dependencyRequestValidator, injectionAnnotations);
    }
}
