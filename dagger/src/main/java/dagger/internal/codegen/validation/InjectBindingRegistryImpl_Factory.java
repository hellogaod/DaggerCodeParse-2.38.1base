...
public final class InjectBindingRegistryImpl_Factory implements Factory<InjectBindingRegistryImpl> {
    ...
    public InjectBindingRegistryImpl get() {
        return newInstance(elementsProvider.get(), typesProvider.get(), messagerProvider.get(), injectValidatorProvider.get(), compilerOptionsProvider.get());
    }
    ...
    public static InjectBindingRegistryImpl_Factory create(Provider<DaggerElements> elementsProvider,
                                                           ...
                                                           Provider<InjectValidator> injectValidatorProvider,
                                                           Provider<CompilerOptions> compilerOptionsProvider) {
        return new InjectBindingRegistryImpl_Factory(elementsProvider, typesProvider, messagerProvider, injectValidatorProvider, compilerOptionsProvider);
    }

    public static InjectBindingRegistryImpl newInstance(DaggerElements elements, DaggerTypes types,
                                                        XMessager messager, InjectValidator injectValidator, CompilerOptions compilerOptions) {
        return new InjectBindingRegistryImpl(elements, types, messager, injectValidator, compilerOptions);
    }
}
