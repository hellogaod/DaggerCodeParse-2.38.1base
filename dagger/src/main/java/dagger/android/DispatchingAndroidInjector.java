...
public final class DispatchingAndroidInjector<T> implements AndroidInjector<T> {
  ...
  private final Map<String, Provider<Factory<?>>> injectorFactories;
   ...
   */
  private static <C, V> Map<String, Provider<Factory<?>>> merge(
      Map<Class<? extends C>, V> classKeyedMap, Map<String, V> stringKeyedMap) {
    if (classKeyedMap.isEmpty()) {
      @SuppressWarnings({"unchecked", "rawtypes"})
      Map<String, Provider<Factory<?>>> safeCast = (Map) stringKeyedMap;
      return safeCast;
    }
    ...
    @SuppressWarnings({"unchecked", "rawtypes"})
    Map<String, Provider<Factory<?>>> safeCast = (Map) merged;
