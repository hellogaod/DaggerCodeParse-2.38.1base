...
public final class GeneratesRootInputs {
    ...
    //1.@ProductionComponent注解节点；
    //2.dagger.hilt.processor.internal.generatesrootinput.codegen包下的类使用@GeneratesRootInputPropagatedData - @GeneratesRootInputPropagatedData#value的值是注解节点。
    ...
    //1.收集@ProductionComponent；
    //2.收集dagger.hilt.processor.internal.generatesrootinput.codegen包下的类使用@GeneratesRootInputPropagatedData - @GeneratesRootInputPropagatedData#value的类型
