...
public abstract class Key {
   ...
   */
  abstract Optional<Wrapper<AnnotationMirror>> wrappedQualifier();
   ...
   */
  abstract Wrapper<TypeMirror> wrappedType();
  ...
  public abstract static class Builder {
    abstract Builder wrappedType(Wrapper<TypeMirror> wrappedType);
    ...
    abstract Builder wrappedQualifier(Wrapper<AnnotationMirror> wrappedQualifier);
