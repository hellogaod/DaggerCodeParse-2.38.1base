...
> 该包下的@DefineComponentClasses注解修饰的节点是通过@DefineComponent修饰的节点生成得来的。
...
1. ImmutableSetMultimap.Builder<ClassName, TypeElement> modulesBuilder：K-@AggregatedDeps#components中的节点,V-@AggregatedDeps#modules节点;hilt源码+案例如下：
 ...
 - (1) k:SingletonComponent,v:DatabaseModule;

 - (2) K:SingletonComponent,V:NetworkModule;

 - (3) K:ViewModelComponent,V:UserDetailsViewModel_HiltModules.BindsModule;

 - (4)K:ActivityRetainedComponent,V:UserDetailsViewModel_HiltModules.KeyModule;

 - (5)K:ViewModelComponent,V:UserListViewModel_HiltModules.BindsModule;

 - (6)K:ActivityRetainedComponent,V:UserListViewModel_HiltModules.KeyModule.

 - (7)K:ActivityComponent,V:HiltWrapper_DefaultViewModelFactories_ActivityModule;

 - (8)K:ViewModelComponent,V:HiltWrapper_HiltViewModelFactory_ViewModelModule;

 - (9)K:ActivityRetainedComponent,V:HiltWrapper_ActivityRetainedComponentManager_LifecycleModule;

 - (10)K:SingletonComponent,V:ApplicationContextModule;

 - (11)K:ActivityComponent,V:HiltWrapper_ActivityModule;


2. ImmutableSetMultimap.Builder<ClassName, TypeElement> entryPointsBuilder：（1）K-@AggregatedDeps#components中的节点,V-@AggregatedDeps#entryPoints;（2）K-SingletonComponent接口,V-@AggregatedEarlyEntryPoint#earlyEntryPoint;案例如下：

 - (1)K:SingletonComponent,V:Application_GeneratedInjector;

 - (2)K:ActivityComponent,V:MainActivity_GeneratedInjector;

 - (3)K:FragmentComponent,V:UserDetailsFragment_GeneratedInjector;

 - (4)K:FragmentComponent,V:UserListFragment_GeneratedInjector;

 - (5)K:ActivityComponent,V:DefaultViewModelFactories.ActivityEntryPoint;

 - (6)K:FragmentComponent,V:DefaultViewModelFactories.FragmentEntryPoint;

 - (7)K:ViewModelComponent,V:HiltViewModelFactory.ViewModelFactoriesEntryPoint;

 - (8)K:ActivityComponent,V:ActivityComponentManager.ActivityComponentBuilderEntryPoint;

 - (9)K:SingletonComponent,V:HiltWrapper_ActivityRetainedComponentManager_ActivityRetainedComponentBuilderEntryPoint;

 - (10)K:ActivityRetainedComponent,V:HiltWrapper_ActivityRetainedComponentManager_ActivityRetainedLifecycleEntryPoint;

 - (11)K:SingletonComponent,V:ServiceComponentManager.ServiceComponentBuilderEntryPoint;

 - (12)K:ActivityComponent,V:ViewComponentManager.ViewComponentBuilderEntryPoint;

 - (13)K:FragmentComponent,V:ViewComponentManager.ViewWithFragmentComponentBuilderEntryPoint;
...
在上面RootGenerator类中生成的`_com_aregyan_github_Application_HiltComponents`中生成内部类：
	...
	public final class _com_aregyan_github_Application_HiltComponents{
		...
		@Generated("dagger.hilt.processor.internal.root.RootProcessor")
		@Module(subcomponents = ViewWithFragmentComponent.class)
		@DisableInstallInCheck
...
前面没有调用，在这里调用了，当前Application生成的代码如下：
