...
demo如下：
	...
	@HiltViewModel
	public MyViewModule extends ViewModule{}

@HiltViewModel修饰的节点生成的类：

	@Generated("ViewModelProcessor")
	@OriginatingElement(topLevelClass = MyViewModule.class)
	public final class MyViewModule_HiltModules {

		private MyViewModule_HiltModules(){}
	    ...
	    public static abstract class BindsModule {
	      ...
	      @Binds
	      @IntoMap
	      @StringKey("pkg.MyViewModule")
	      @HiltViewModelMap
	      public abstract ViewModel binds(MyViewModule vm)
	    }
